...
- Create a new folder in same folder as yt-dlp and name it `yt_dlp_plugins`.

- Unzip `bgutil-ytdlp-pot-provider-deno-compat.zip` into the above `yt_dlp_plugins` folder.
